...
namespace System
{
    public static class Seguridad
    {
        ...
        //Encripta el string de la conexion
        public static string EncriptaConnexion(string pCadena)
        {
            byte[] Clave = Encoding.ASCII.GetBytes("5&(/58Jet7G5r4g%5/&$8&$!");
            byte[] IV = Encoding.ASCII.GetBytes("Devjoker7.37hAES");
            byte[] inputBytes = Encoding.ASCII.GetBytes(pCadena);
            byte[] encripted = null;
        ...
        public static string DesencriptaConexion(string pCadena)
        {
            byte[] Clave = Encoding.ASCII.GetBytes("5&(/58Jet7G5r4g%5/&$8&$!");
            byte[] IV = Encoding.ASCII.GetBytes("Devjoker7.37hAES");
