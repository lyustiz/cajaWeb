...
namespace Alex75.JsonViewer.WindowsForm
{
    ...
    public class JsonTreeView : TreeView
    {
        ...
        public void ShowJson(string jsonString, string table = "(root)")
        {
        ...
        private void LoadTree(JObject json, string table)
        {
            Nodes.Clear();            

            var rootNode = new JsonTreeNode(NodeType.Object, table);
            Nodes.Add(rootNode);
